    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:hover:text-white"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white"
        ),
